...
public class WhiteTimerController : MonoBehaviourPunCallbacks, IPunObservable
{
	...
	void Update () 
	{
		...
		if (player == "white" && gameScript.gameOver == false)
		{
		    ...
		    // Time Limit
		    if(totalTime <= 0f) 
				gameScript.GetComponent<Game>().Winner("black");
		}
		else
